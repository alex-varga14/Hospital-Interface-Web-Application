...
-- INSERT INTO users VALUES('johnSmith', 'johnsmith@gmail.com', )
...
INSERT INTO doctors(userID, username, dob, password, specialization, patientID, facilityID)
VALUES('5', 'docman', '1972-01-10', 'docman123', 'Respiratory', '1', 'John Hopkins');

INSERT INTO doctors(userID, username, dob, password, specialization, patientID, facilityID)
VALUES('6', 'doctorpepper', '1954-01-11', 'softdrink123', 'Cardiology', '2', 'John Hopkins');

INSERT INTO doctors(userID, username, dob, password, specialization, patientID, facilityID)
VALUES('7', 'johnsmith', '1957-03-18', 'gramms2123', 'Ophthalmology', '3', 'Rockyview Hospital');

INSERT INTO doctors(userID, username, dob, password, specialization, patientID, facilityID)
VALUES('8', 'joejoe', '1990-02-13', 'joe546', 'Respiratory', '4', 'Foothills Medical Center');
...
INSERT INTO appointments(apptID, summary, apptDate, bloodPressure, temperature, patientID, requested, doctorId)
VALUES('762', 'Exercise more', '2022-04-14', '80', '37', '1', '1', '5');

INSERT INTO appointments(apptID, summary, apptDate, bloodPressure, temperature, patientID, requested, doctorId)
VALUES('761', 'Drink less', '2022-03-14', '80', '36', '1', '0', '6');

INSERT INTO appointments(apptID, summary, apptDate, bloodPressure, temperature, patientID, requested, doctorId)
VALUES('763', 'Drink more vitamins', '2022-03-15', '81', '36', '2', '0', '5');

INSERT INTO appointments(apptID, summary, apptDate, bloodPressure, temperature, patientID, requested, doctorId)
VALUES('764', 'At risk of heart attack', '2022-03-16', '80', '37', '3', '1', '7');

INSERT INTO appointments(apptID, summary, apptDate, bloodPressure, temperature, patientID, requested, doctorId)
VALUES('765', 'Eat more vegetables and sleep early', '2022-03-17', '80', '37', '4', '0', '8');

INSERT INTO prescriptions(prescID, instructions, refilDate, medications, patientID, doctorId)
VALUES('8772', 'Take twice daily', '2022-05-14', 'Puffer', '1', '5');

INSERT INTO prescriptions(prescID, instructions, refilDate, medications, patientID, doctorId)
VALUES('8773', 'Take one after every meal', '2022-05-17', 'Salbutamol', '2', '6');

INSERT INTO prescriptions(prescID, instructions, refilDate, medications, patientID, doctorId)
VALUES('8774', 'Take two tablets before sleeping', '2022-05-29', 'Cefuroxime', '3', '7');

INSERT INTO prescriptions(prescID, instructions, refilDate, medications, patientID, doctorId)
VALUES('8775', 'Fast for eight hours before taking', '2022-06-19', 'Remdesivir', '4', '8');
...
INSERT INTO operations(operationNum, operationType, time, complete, surgeonID, facilityID)
VALUES('2314', 'Head', '2022-04-16', '0', '9', 'John Hopkins');

INSERT INTO operations(operationNum, operationType, time, complete, surgeonID, facilityID)
VALUES('2315', 'Heart', '2022-04-17', '0', '9', 'John Hopkins');

INSERT INTO operations(operationNum, operationType, time, complete, surgeonID,  facilityID)
VALUES('2316', 'Liver', '2022-05-11', '1', '10', 'Rockyview Hospital');

INSERT INTO operations(operationNum, operationType, time, complete, surgeonID, facilityID)
VALUES('2317', 'Kidney', '2022-06-14', '0', '11', 'Foothills Medical Center');
